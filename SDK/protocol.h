...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "i5naxlm2bxbh14ig"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//设备自检结果(只上报)
//备注:
#define DPID_CHECKING_RESULT 1
//燃气检测状态(只上报)
//备注:
#define DPID_GAS_SENSOR_STATE 2
//燃气检测值(只上报)
//备注:
#define DPID_GAS_SENSOR_VALUE 5
//预热(只上报)
//备注:
#define DPID_PREHEAT 10
//报警开关(可下发可上报)
//备注:
#define DPID_ALARM_SWITCH 12
//消音(可下发可上报)
//备注:
#define DPID_MUFFLING 14
//是否检测到燃气(只上报)
//备注:
#define DPID_IS_AS_DETECTED 101
